...
public class MapperScannerConfigurer
    ...
    protected Set<BeanDefinitionHolder> doScan(String... basePackages) {
        ...
        // 在父类org.springframework.context.annotation.ClassPathBeanDefinitionScanner中执行注册
...
# 代理对象处理
	# 1. 获取SqlSession对象
		# 通过SqlSessionUtils.getSqlSession获取DefaultSqlSession对象
		...
		# 创建SqlSession时，通过TransactionFactory，获取Transaction对象
			# org.apache.ibatis.transaction.TransactionFactory#newTransaction
		# SqlSession执行操作
			# 从Transaction对象对象中获取连接
